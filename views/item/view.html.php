 ...
 * @since  0.0.1
 */
class K2toflexiViewItem extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		K2toflexidHelper::addSubmenu('item');
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title(JText::_("Selection des items"));
		...
		if ( !JComponentHelper::isEnabled( 'com_flexicontent', true) ) {
			...
			JToolBarHelper::custom('k2toflexi.migrate', 'copy.png', 'copy_f2.png', 'Item', false, true);
		}
