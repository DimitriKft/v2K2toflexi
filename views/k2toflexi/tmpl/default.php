...
<?php endif;?>
<div id="contenu">
	<div id="titre" class="page-header"><h1><?php echo JText::_("COM_K2TOFLEXI_MIGRATE_TITLE"); ?></h1></div>
	<div id="k2toflexi"><button id="renderbutton" type="button" class="btn btn-primary" value="renderbutton" onclick="waitForFirstData();"><?php echo JText::_('COM_K2TOFLEXI_BUTTON'); ?></button></div>
