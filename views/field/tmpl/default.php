...
<div id="contenu">
	<div id="titre" class="page-header"><h1><?php echo 'Migrer vos Fields'; ?></h1></div>
	<div id="k2toflexi"><button id="renderbutton" type="button" class="btn btn-primary" value="renderbutton" onclick="waitForFirstData();"><?php echo 'Migrer vos Fields'; ?></button></div>
...
function NextData(data){
	...
	jQuery.ajax({
		method: "post",
		url:"index.php?option=com_k2toflexi&task=field.field&tmpl=component",
		data : {json: data},
	    dataType : "json",
	...
	jQuery.ajax({
		method: "post",
		url:"index.php?option=com_k2toflexi&task=field.firstmigrateField&tmpl=component",
	    dataType : "json",
