...
<?php if (!empty( $this->sidebar)) : ?>
	...
	<h2 class="t3-off-canvas-header-title"><?php echo JText::_('Séléction des tags') ?></h2>
...
<div id="contenu">
	<div id="titre" class="page-header"><h1><?php echo 'Migrer vos Tag'; ?></h1></div>
	<div id="k2toflexi"><button id="renderbutton" type="button" class="btn btn-primary" value="renderbutton" onclick="waitForFirstData();"><?php echo 'Migrer vos tags'; ?></button></div>
...
function NextData(data){
	...
	jQuery.ajax({
		method: "post",
		url:"index.php?option=com_k2toflexi&task=tag.tag&tmpl=component",
		data : {json: data},
	    dataType : "json",
	...
	jQuery.ajax({
		method: "post",
		url:"index.php?option=com_k2toflexi&task=tag.firstmigrateTag&tmpl=component",
	    dataType : "json",
